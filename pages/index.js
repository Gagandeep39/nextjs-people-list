    ...
    <>
      ...
      <div>
        ...
        <p className={styles.text}>
          ...
          nec, blandit blandit arcu. Aliquam a egestas dolor, non tristique
          neque. Aliquam augue sapien, tempus in lectus sit amet, malesuada
          venenatis diam. Curabitur nec consectetur massa. Duis tincidunt nunc
          facilisis tellus tempus feugiat. Mauris vitae diam purus. Curabitur
          sollicitudin eros eu egestas iaculis. Nullam fringilla eleifend turpis
          non pellentesque. Integer suscipit ultricies nisl in elementum. Duis
          sapien elit, viverra vel lectus volutpat, vestibulum vulputate enim.
          Ut nec odio lacinia, elementum est eu, efficitur libero. In eleifend
          erat nec ante venenatis, nec laoreet quam tristique. Donec finibus
          vehicula dolor ac volutpat. Maecenas laoreet urna eu vulputate
          vulputate.
        </p>
        <Link href="/people">
